...
import BarChartTime from "@/components/charts/BarChartTime.jsx";
import HeatMap from "@/components/charts/HeatMap.jsx";
import TrendChartStockFixed from "@/components/charts/TrendChartStockFixed.jsx";
import Radar from "@/components/charts/RadarChart.jsx";
...
class Options extends Component {
  render() {
    ...
    return (
      <motion.button
        className={`flex flex-row items-center py-3 px-5 gap-2 mt-2 mb-1 rounded-lg font-[lato] font-semibold text-md ${className}`}
