...
const Footer = ({ id }) => {
  return (
    <div
      className="flex flex-col text-[#f6f8fb] mt-[5%] items-center bg-[#182433]"
      id={id}
    >
      <div className="flex flex-row w-full px-[5%] py-[4%]">
        <div className="flex md:flex-col flex-row w-1/3">
          ...
          <div className="flex flex-row border-2 w-[27rem] pl-7 justify-between rounded-full my-5 focus:border-white">
            <input
              type="email"
            ...
            <motion.button
              ...
              className=" rounded-full px-8 text-white bg-blue-600 my-2 text-sm mr-4"
            >
              Submit
            </motion.button>
          </div>
